...
#
# zybo_epi.tcl: Tcl script for re-creating project 'zybo_epi'
#
# Generated by Vivado on Mon Apr 08 13:24:00 +0300 2019
...
#
# 1. This project restoration tcl script (zybo_epi.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "D:/ProgramsData/Vivado/zybo_epi/zybo_epi.srcs/sources_1/bd/main_design/hdl/main_design_wrapper.v"
#
...
set_property -name "ip_output_repo" -value "D:/ProgramsData/Vivado/${_xil_proj_name_}/${_xil_proj_name_}.cache/ip" -objects $obj
set_property -name "mem.enable_memory_map_generation" -value "1" -objects $obj
set_property -name "project_type" -value "Default" -objects $obj
set_property -name "pr_flow" -value "0" -objects $obj
set_property -name "sim.central_dir" -value "D:/ProgramsData/Vivado/${_xil_proj_name_}/${_xil_proj_name_}.ip_user_files" -objects $obj
...
set_property "ip_repo_paths" "D:/ProgramsData/Vivado/ip_repo/axi_dma_test_ip_1.0 [file normalize "$origin_dir/Proiect_Andrei Georgian"]" $obj
...
set files [list \
 "../src/bd/main_design/hdl/main_design_wrapper.v"\
]
...
set file "hdl/main_design_wrapper.v"
...
set_property -name "top" -value "main_design_wrapper" -objects $obj
...
# Proc to create BD main_design
proc cr_bd_main_design { parentCell } {
  ...
  xilinx.com:user:inspection_unit:1.0\
...
# End of cr_bd_main_design()
cr_bd_main_design ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files main_design.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files main_design.bd ] 
set_property IS_ENABLED "1" [get_files main_design.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files main_design.bd ] 
set_property IS_LOCKED "0" [get_files main_design.bd ] 
set_property IS_MANAGED "0" [get_files main_design.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files main_design.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files main_design.bd ] 
set_property PFM_NAME "" [get_files main_design.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files main_design.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files main_design.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files main_design.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files main_design.bd ] 
set_property USED_IN_SIMULATION "1" [get_files main_design.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files main_design.bd ] 
...
if {[string equal [get_runs -quiet impl_2] ""]} {
    create_run -name impl_2 -part xc7z020clg400-1 -flow {Vivado Implementation 2018} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_2
} else {
